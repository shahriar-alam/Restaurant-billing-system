...
//			public void run() {
//				try {
//					UserPanel frame = new UserPanel(p1);
...
//	 */
	...
	public UserPanel(People p1) {
		...
		button2.setBounds(422, 289, 150, 60);
		panel1.add(button2);
		...
		button3.setBounds(422, 200, 150, 60);
		panel1.add(button3);
		
		JButton button4 = new JButton("Confirm Order");
		...
		button4.setBounds(422, 109, 150, 60);
		panel1.add(button4);
